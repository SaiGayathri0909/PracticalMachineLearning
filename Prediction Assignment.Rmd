...
```{r}
training_data <- read.csv("C:\\Users\\ssaisankar\\Desktop\\DSS\\PracticalMachineLearning\\pmltraining.csv", na.strings = c("NA", "#DIV/0!", ""))
test_data <- read.csv("C:\\Users\\ssaisankar\\Desktop\\DSS\\PracticalMachineLearning\\pmltesting.csv", na.strings = c("NA", "#DIV/0!", ""))
```
## Data cleaning
```{r}
training_data <- read.csv("C:\\Users\\ssaisankar\\Desktop\\DSS\\PracticalMachineLearning\\pmltraining.csv", na.strings = c("NA", "#DIV/0!", ""))
